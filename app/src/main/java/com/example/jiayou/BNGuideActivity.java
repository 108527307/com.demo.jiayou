...
public class BNGuideActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        BaiduMapFragment.activityList.add(this);
        createHandler();
        ...
        if (intent != null) {
            ...
            if (bundle != null) {
                mBNRoutePlanNode = (BNRoutePlanNode) bundle.getSerializable(BaiduMapFragment.ROUTE_PLAN_NODE);
    ...
    protected void onDestroy() {
        ...
        BaiduMapFragment.activityList.remove(this);
